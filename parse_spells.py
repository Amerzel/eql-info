...
SCALAR_SCHEMA = [
    ...
    # Inserted by the 2026-06-29 patch. All-zero across every spell except
    # one ("Bottle of Alternate Adventure I" = -1). Suspected placeholder
    # for the spell-upgrade system (motes) — second half ships during
    # the first week of Preorder Beta per dev note.
    (103, "eql_upgrade_placeholder", int, 1),
    (104, "pvp_resist_base", int, 1),
    (105, "pvp_resist_per_level", int, 1),
    (106, "pvp_resist_cap", int, 1),
    (107, "pvp_duration", int, 1),
    (108, "pvp_duration_cap", int, 1),
    (109, "pcnpc_only_flag", int, 1),
    (110, "cast_not_standing", int, 1),
    (111, "can_mgb", int, 1),
    (112, "dispel_flag", int, 1),
    (113, "npc_category", int, 1),
    (114, "npc_usefulness", int, 1),
    (115, "min_resist", int, 1),
    (116, "max_resist", int, 1),
    (117, "viral_targets", int, 1),
    (118, "viral_timer", int, 1),
    (119, "nimbus_effect", int, 1),
    (120, "directional_start", float, 1),
    (121, "directional_end", float, 1),
    (122, "sneak", int, 1),
    (123, "not_focusable", int, 1),
    (124, "no_detrimental_spell_aggro", int, 1),
    (125, "show_wear_off_message", int, 1),
    (126, "suspendable", int, 1),
    (127, "viral_range", int, 1),
    (128, "song_cap", int, 1),
    (129, "stacks_with_self", int, 1),
    (130, "not_shown_to_player", int, 1),
    (131, "no_block", int, 1),
    (132, "anim_variation", int, 1),
    (133, "spell_group", int, 1),
    (134, "rank", int, 1),
    (135, "no_resist", int, 1),
    (136, "allow_spellscribe", int, 1),
    (137, "cast_restriction", int, 1),
    (138, "allow_rest", int, 1),
    (139, "can_cast_in_combat", int, 1),
    (140, "can_cast_out_of_combat", int, 1),
    (141, "show_dot_message", int, 1),
    (142, "invalid", int, 1),
    (143, "aoe_max_targets", int, 1),
    (144, "no_heal_damage_item_mod", int, 1),
    (145, "caster_requirement_id", int, 1),
    (146, "spell_class", int, 1),
    (147, "spell_subclass", int, 1),
    (148, "ai_valid_targets", int, 1),
    (149, "persist_death", int, 1),
    (150, "base_effects_focus_slope", float, 1),
    (151, "base_effects_focus_offset", float, 1),
    (152, "min_distance", float, 1),
    (153, "min_distance_mod", float, 1),
    (154, "max_distance", float, 1),
    (155, "max_distance_mod", float, 1),
    (156, "min_range", float, 1),
    (157, "no_remove", int, 1),
    (158, "spell_recourse_type", int, 1),
    (159, "only_during_fast_regen", int, 1),
    (160, "is_beta_only", int, 1),
    (161, "spell_subgroup", int, 1),
    (162, "eql_new_2", int, 1),
    (163, "eql_new_3", float, 1),
    (164, "eql_new_4", float, 1),
    (165, "spell_category", int, 1),
    ...
    (166, "eql_reserved_1", int, 1),
    (167, "eql_pet_template", int, 1),
    (168, "eql_reserved_2", int, 1),
    (169, "eql_reserved_3", int, 1),
    (170, "eql_reserved_4", int, 1),
